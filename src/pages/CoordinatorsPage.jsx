...
function RoleModal({ isOpen, onClose, userData, onChangeRole }) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] bg-slate-900/40 backdrop-blur-[2px] flex items-stretch justify-center p-2 md:items-center md:p-4">
      <div className="flex w-full max-w-md max-h-[calc(100dvh-1rem)] md:max-h-[calc(100dvh-2rem)] flex-col bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
